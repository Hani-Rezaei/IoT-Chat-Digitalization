...
///////////////////////////////////////////////////
/* Sensordaten-Buffer */
static char sensor_data[64] = "Dummy sensor data";

/* UUID für die Sensordaten (kann beliebig gewählt werden) */
static const ble_uuid128_t gatt_svr_chr_sensor_data_uuid
        = BLE_UUID128_INIT(0x35, 0xa3, 0xc7, 0x14, 0x3e, 0x03, 0x3e, 0xa1, 0xff,
                0x48, 0x37, 0xd1, 0x7f, 0x39, 0xce, 0x1b);

static int gatt_svr_chr_access_sensor_data(
...
static const struct ble_gatt_svc_def gatt_svr_svcs[] = {
    ...
    },
    {
        ...
        {
            /* Sensordaten-Charakteristik */
            .uuid = (ble_uuid_t*) &gatt_svr_chr_sensor_data_uuid.u,
...
static int gatt_svr_chr_access_sensor_data(
        ...
        struct ble_gatt_access_ctxt *ctxt, void *arg)
{
    puts("service 'sensor data' callback triggered");
    ...
    /* Dummy-Sensordaten */
    snprintf(sensor_data, sizeof(sensor_data), "Temperature: 25.4°C, Humidity: 45%%");

    /* Daten an den Client senden */
    int rc = os_mbuf_append(ctxt->om, sensor_data, strlen(sensor_data));
